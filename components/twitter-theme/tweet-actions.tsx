...
export const TweetActions = ({ tweet }: { tweet: EnrichedTweet }) => {
  ...
  return (
    <View className="flex-row items-center text-gray-500 pt-1 mt-1 border-t border-gray-200">
      <TouchableOpacity
        ...
        <View className="w-8 h-8 -ml-1 rounded-full flex items-center justify-center">
          <Svg viewBox="0 0 24 24" className="w-5 h-5" aria-hidden>
            <Path
              ...
              fill="rgb(249, 24, 128)" // Exact pink color
            />
          </Svg>
        </View>
        <Text className="text-sm font-semibold ml-1">{favoriteCount}</Text>
      </TouchableOpacity>
        ...
        <View className="w-8 h-8 -ml-1 rounded-full flex items-center justify-center">
          <Svg viewBox="0 0 24 24" className="w-5 h-5" aria-hidden>
            <Path
              ...
              fill="rgb(29, 155, 240)" // Exact blue color
            />
          </Svg>
        </View>
        <Text className="text-sm font-semibold ml-1">Reply</Text>
      </TouchableOpacity>
